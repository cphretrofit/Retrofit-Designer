...
export const deleteDocument = (projectId, docId) => api.delete(`/projects/${projectId}/documents/${docId}`).then((r) => r.data);
...
export const autofillAllBuildups = (id, force = false) => api.post(`/projects/${id}/measures/autofill-buildups-all`, null, { params: { force } }).then((r) => r.data);
export const setCoverPhoto = (id, url) => api.put(`/projects/${id}/cover-photo`, { url }).then((r) => r.data);
...
export const saveDrawingSignoffs = (id, drawingSignoffs) =>
  api.put(`/projects/${id}/drawing-signoffs`, { drawingSignoffs }).then((r) => r.data);
